    ...
    <div class="container">
        ...
        <div class="sideBox clearfix">
            <ul class="insideMenu clearfix">
            	...
            	<li><a href="<?php echo U("/Information/index/cid/$key");?>"><?php echo ($val["title"]); ?></a></li>
            	<?php }?>
            </ul>
...
<div class="container">
	<div class="newsDetail">
    	<div class="newsDTil clearfix">
        	<div class="title"><?php echo ($result["title"]); ?></div>
            <a href='<?php echo U("/Information/index/cid/$result[cat_id]")?>'><img src="/Public/site/img/btn_back.gif"></a>
        </div>
        <div class="newsSecond">
        	分类：
            <a href='<?php echo U("/Information/index/cid/$result[cat_id]")?>'><?php echo ($result["cat_name"]); ?></a>
            发布时间：
            <span><?php echo (date("Y/m/d",$result["dateline"])); ?></span>
            <div style="display:none;">|  浏览次数：<span>519</span>  | </div> 
        </div>
