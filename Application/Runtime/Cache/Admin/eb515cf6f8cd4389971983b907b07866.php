...
var onmol = function(obj){
	var id  = $(obj).attr('data-id');	
	 the_id = $.layer({
	    ...
	    border: [0],
	    iframe: {
	        src: '/admin.php/Cmsmanager/link_edit/id/'+id
	    },
	    title: false,
	    area: ['1000px','600px']
	}); 
...
var ajaxpage = function(obj){
	...
	$(function(){
		var url = "/admin.php/Cmsmanager/link_show/do/load/p/"+dp;
...
var ondel = function(id){
	$.layer({
	    ...
	    dialog: {
	        ...
	        btn: ['确定','取消'],
	        yes: function(){
	        		var url = "/admin.php/Cmsmanager/link_del/do/del/id/"+id;
...
var oncat = function(obj){		
 	$.layer({
	    ...
	    border: [0],
	    iframe: {
	        src: "/admin.php/Cmsmanager/link_cat"
	    },
	    title: false,
	    area: ['1200px','600px']
	}); 
