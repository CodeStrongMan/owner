...
var loadlist = function(){	
	$(function(){
		var url = "/admin.php/Cmsmanager/goods_cat/do/load"
...
var ondel = function(obj){
	...
	$.layer({
	    ...
	    dialog: {
	        ...
	        btn: ['确定','取消'],
	        yes: function(){
	        		var url = "/admin.php/Cmsmanager/goods_cat_del/do/del/code/"+code;
...
$(function(){
	$('#thesubmit').bind('click',function(){
		...
		var obj     = this;
		var url     = '/admin.php/Cmsmanager/goods_cat_post';
